...
input[type="text" i] {
    ...
    <body>
        <form action="ucapan.php" method="post">
            ...
            <input style="background: rgba(0, 0, 0, 0);" class="form-control" type="text" name="guestbook-name" <?php
                if(isset($_GET['to'])){
                    $to = $_GET['to'];
                    echo "value='$to'";
                } else {
            ...
            <textarea class="form-control" rows="3" name="guestbook-message" placeholder="Berikan Ucapan Dan Doa Restu"
                required></textarea>
            <div class="guestbook-label">
                <label class="elementor-screen-only">
                </label>
            </div>
            <select class="form-control" name="guestbook-confirm" required>
                <option>Konfirmasi
                    Kehadiran</option>
            ...
            <div class="elementor-button-wrapper" 
                ...
                <button type="submit" class="elementor-button-link elementor-button elementor-size-sm"
                    style="display: block; margin: auto; border-radius: 40px; "
                    >
